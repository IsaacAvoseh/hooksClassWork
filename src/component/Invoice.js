...
export default function Invoice() {
    ...
    const handleSubmit = (e) => {
        ...
        localStorage.setItem('invoices', JSON.stringify(payload));
    }

    const handleChange = (e) => {
        // e.persist();
        if (e.target.name === "bankName" || e.target.name === "accountNumber" || e.target.name === 'swiftCode' || e.target.name === 'country' || e.target.name === 'notes') {
            const account = { ...invoice.account, [e.target.name]: e.target.value}
            setInvoice({...invoice,  "account" : account})
        }else if (e.target.name === "currency" || e.target.name === "tax") {
            const currency = { ...invoice.currency, [e.target.name]: e.target.value}
            setInvoice({...invoice,  "currency" : currency})
        }else if(e.target.name === "description" || e.target.name === "additionalDetails" || e.target.name === "quantity" || e.target.name === "price"){
            const items = [...invoice.items]
            items[0][e.target.name] = e.target.value
        ...
        setInvoice({
            ...
            // ...invoice.items, [e.target.name]: e.target.value,
            // ...invoice.account, [e.target.name]: e.target.value,
            // ...invoice.currency, [e.target.name]: e.target.value,
                                              ...
                                              <div className="invoice-detail-title">
                                                  <div className="invoice-logo">
                                                      <div className="upload">
                                                          <input value={invoice.image} onChange={handleChange} type="file" id="input-file-max-fs" name='image' className="dropify" data-max-file-size="2M" />
                                                      </div>
                                                  </div>
                                                  <div className="invoice-title">
                                                      <input type="text" value={invoice.label} onChange={handleChange} name='label' className="form-control" placeholder="Invoice Label" defaultValue="Invoice Label" />
                                                  </div>
                                              </div>
                                                          ...
                                                          <div className="invoice-address-company-fields">
                                                              <div className="form-group row">
                                                                  ...
                                                                  <div className="col-sm-9">
                                                                      <input type="text" className="form-control form-control-sm" id="company-name" value={invoice.fromName} name='fromName' onChange={handleChange} placeholder="Business Name" />
                                                                  </div>
                                                              </div>
                                                              <div className="form-group row">
                                                                  <label htmlFor="company-email" className="col-sm-3 col-form-label col-form-label-sm">Email</label>
                                                                  <div className="col-sm-9">
                                                                      <input value={invoice.fromEmail} name='fromEmail' onChange={handleChange} type="text" className="form-control form-control-sm" id="company-email" placeholder="name@company.com" />
                                                                  </div>
                                                              </div>
                                                              <div className="form-group row">
                                                                  <label htmlFor="company-address" className="col-sm-3 col-form-label col-form-label-sm">Address</label>
                                                                  <div className="col-sm-9">
                                                                      <input value={invoice.fromAddress} name='fromAddress' onChange={handleChange} type="text" className="form-control form-control-sm" id="company-address" placeholder="XYZ Street" />
                                                                  </div>
                                                              </div>
                                                              <div className="form-group row">
                                                                  <label htmlFor="company-phone" className="col-sm-3 col-form-label col-form-label-sm">Phone</label>
                                                                  <div className="col-sm-9">
                                                                      <input value={invoice.fromPhone} onChange={handleChange} name='fromPhone' type="text" className="form-control form-control-sm" id="company-phone" placeholder="(123) 456 789" />
                                                                  </div>
                                                              </div>
                                                          </div>
                                                      </div>
                                                      <div className="col-xl-5 invoice-address-client">
                                                          ...
                                                          <div className="invoice-address-client-fields">
                                                              <div className="form-group row">
                                                                  ...
                                                                  <div className="col-sm-9">
                                                                      <input value={invoice.toName} onChange={handleChange} name='toName' type="text" className="form-control form-control-sm" id="client-name" placeholder="Client Name" />
                                                                  </div>
                                                              </div>
                                                              <div className="form-group row">
                                                                  <label htmlFor="client-email" className="col-sm-3 col-form-label col-form-label-sm">Email</label>
                                                                  <div className="col-sm-9">
                                                                      <input value={invoice.toEmail} onChange={handleChange} name='toEmail' type="text" className="form-control form-control-sm" id="client-email" placeholder="name@company.com" />
                                                                  </div>
                                                              </div>
                                                              <div className="form-group row">
                                                                  <label htmlFor="client-address" className="col-sm-3 col-form-label col-form-label-sm">Address</label>
                                                                  <div className="col-sm-9">
                                                                      <input value={invoice.toAddress} onChange={handleChange} name='toAddress' type="text" className="form-control form-control-sm" id="client-address" placeholder="XYZ Street" />
                                                                  </div>
                                                              </div>
                                                              <div className="form-group row">
                                                                  <label htmlFor="client-phone" className="col-sm-3 col-form-label col-form-label-sm">Phone</label>
                                                                  <div className="col-sm-9">
                                                                      <input value={invoice.toPhone} onChange={handleChange} name='toPhone' type="text" className="form-control form-control-sm" id="client-phone" placeholder="(123) 456 789" />
                                                                  </div>
                                                              </div>
                                                          </div>
                                                      </div>
                                                  ...
                                                  <div className="row justify-content-between">
                                                      <div className="col-md-3">
                                                          <div className="form-group mb-4">
                                                              ...
                                                              <input value={invoice.number} onChange={handleChange} name='number' type="text" className="form-control form-control-sm" id="number" placeholder="#0001" />
                                                          </div>
                                                      </div>
                                                      <div className="col-md-3">
                                                          <div className="form-group mb-4">
                                                              <label htmlFor="date">Invoice Date</label>
                                                              <input value={invoice.date} onChange={handleChange} type="date" name='date' className="form-control form-control-sm" id="date" placeholder="Add date picker" />
                                                          </div>
                                                      </div>
                                                      <div className="col-md-3">
                                                          <div className="form-group mb-4">
                                                              <label htmlFor="due">Due Date</label>
                                                              <input value={invoice.dueDate} onChange={handleChange} name='dueDate' type="date" className="form-control form-control-sm" id="due" placeholder="None" />
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
                                                      ...
                                                      <table className="table table-bordered item-table">
                                                          ...
                                                          <tbody>
                                                              <tr>
                                                                  ...
                                                                  <td className="description"><input type="text" className="form-control form-control-sm" placeholder="Item Description" value={invoice.items.description} name='description' onChange={handleChange} /> <textarea className="form-control" placeholder="Additional Details" value={invoice.items.additionalDetails} onChange={handleChange} name='additionalDetails' defaultValue={""} /></td>
                                                                  <td className="rate">
                                                                      <input type="text" value={invoice.items.price} onChange={handleChange} name='price'  className="form-control form-control-sm" placeholder="Price" />
                                                                  </td>
                                                                  <td className="text-right qty"><input type="text" value={invoice.items.quantity} onChange={handleChange} name='quantity' className="form-control form-control-sm" placeholder="Quantity" /></td>
                                                                  <td className="text-right amount"><span className="editable-amount"><span className="currency">$</span> <span className="amount">xxxx</span></span></td>
                                                  ...
                                                  <div className="row">
                                                      <div className="col-md-6">
                                                          <div className="form-group row invoice-created-by">
                                                              ...
                                                              <div className="col-sm-9">
                                                                  <input value={invoice.account.accountNumber} onChange={handleChange}  name='accountNumber' type="text" className="form-control form-control-sm" id="payment-method-account" placeholder="Bank Account Number" />
                                                              </div>
                                                          </div>
                                                          <div className="form-group row invoice-created-by">
                                                              <label htmlFor="payment-method-bank-name" className="col-sm-3 col-form-label col-form-label-sm">Bank Name:</label>
                                                              <div className="col-sm-9">
                                                                  <input value={invoice.account.bankName} name='bankName' onChange={handleChange} type="text" className="form-control form-control-sm" id="payment-method-bank-name" placeholder="Insert Bank Name" />
                                                              </div>
                                                          </div>
                                                          <div className="form-group row invoice-created-by">
                                                              <label htmlFor="payment-method-code" className="col-sm-3 col-form-label col-form-label-sm">SWIFT code:</label>
                                                              <div className="col-sm-9">
                                                                  <input value={invoice.account.swiftCode} name='swiftCode' onChange={handleChange} type="text" className="form-control form-control-sm" id="payment-method-code" placeholder="Insert Code" />
                                                              </div>
                                                          </div>
                                                          <div className="form-group row invoice-created-by">
                                                              <label htmlFor="payment-method-country" className="col-sm-3 col-form-label col-form-label-sm">Country:</label>
                                                              <div className="col-sm-9">
                                                                  <select name="country" name='country' value={invoice.account.country} onChange={handleChange}className="form-control country_code  form-control-sm" id="payment-method-country">
                                                              ...
                                                              <div className="invoice-totals-row invoice-summary-subtotal">
                                                                  ...
                                                                  <div className="invoice-summary-value">
                                                                      <div className="subtotal-amount">
                                                                          <span className="currency">$</span><span className="amount">xxx</span>
                                                                      </div>
                                                                  </div>
                                                              </div>
                                                              <div className="invoice-totals-row invoice-summary-total">
                                                                  ...
                                                                  <div className="invoice-summary-value">
                                                                      <div className="total-amount">
                                                                          <span className="currency">$</span><span>xx</span>
                                                                      </div>
                                                                  </div>
                                                              </div>
                                                              ...
                                                              <div className="invoice-totals-row invoice-summary-balance-due">
                                                                  ...
                                                                  <div className="invoice-summary-value">
                                                                      <div className="balance-due-amount">
                                                                          <span className="currency">$</span><span>xxxx</span>
                                                                      </div>
                                                                  </div>
                                                              </div>
                                                          </div>
                                                      ...
                                                      <div className="col-md-12 align-self-center">
                                                          <div className="form-group row invoice-note">
                                                              ...
                                                              <div className="col-sm-12">
                                                                  <textarea className="form-control" value={invoice.account.notes} onChange={handleChange} name='notes' id="invoice-detail-notes" placeholder="Notes - For example, &quot;Thank you for doing business with us&quot;" style={{ height: '88px' }} />
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
                                          ...
                                          <div className="invoice-action-currency">
                                              <div className="form-group mb-0">
                                                  ...
                                                  <div className="dropdown selectable-dropdown invoice-select">
                                                      ...
                                                      <div value={invoice.currency} onChange={handleChange} name='currency' className="dropdown-menu" aria-labelledby="currencyDropdown">
                                                      ...
                                                      <div className="col-6">
                                                          <div className="form-group mb-0">
                                                              ...
                                                              <div className="dropdown selectable-dropdown invoice-tax-select">
                                                                  ...
                                                                  <div value={invoice.tax} onChange={handleChange} name='tax' className="dropdown-menu" aria-labelledby="currencyDropdown">
                                      ...
                                      <div className="invoice-actions-btn">
                                          <div className="invoice-action-btn">
                                              <div className="row">
                                                  ...
                                                  <div className="col-xl-12 col-md-4">
                                                      <a href="/preview" className="btn btn-dark btn-preview">Preview</a>
                                                  </div>
                                                  <div className="col-xl-12 col-md-4">
                                                      <p onClick={handleSubmit} className="btn btn-success btn-download">Save</p>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
